  ...
  if (event.metaKey && event.shiftKey && event.which === 83) {
    ...
    chrome.storage.local.get([page], function(result) {
        ...
        chrome.storage.local.set(object, function() {            
            ...
            document.getElementsByTagName('body')[0].insertAdjacentHTML( 'afterbegin', "<div class='tomtobypopup' id='tomtobyid'><div><div class='tomtobytext'>"+text.substring(1,50)+"</div><textarea rows='4'></textarea><div class='tomtobysaved'>Saved</div><div class='tomtobybutton'><a href='"+browser_page+"#"+page+"'>See Quotes</div></div></div>" );
